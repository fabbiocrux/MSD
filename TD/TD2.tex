...
\hypersetup{
  pdftitle={TD 2: Matrice de Déformations},
  colorlinks=true,
  linkcolor={blue},
  filecolor={Maroon},
  citecolor={Blue},
...
\title{TD 2: Matrice de Déformations}
\usepackage{etoolbox}
\makeatletter
...
\tightlist
\item
  Calculer la matrice de déformation \(\underline{E}\) associé su
...
\hypertarget{calculer-la-matrice-de-duxe9formations}{%
\subsubsection{Calculer la Matrice de
Déformations}\label{calculer-la-matrice-de-duxe9formations}}
